...
function wrap(item) {
  return wrap_unwrap_all(item, wrapSingle);
}

function unwrap(item) {
  return wrap_unwrap_all(item, unwrapSingle);
}

var wrapSingle = (function wrapping(){
  ...
  // not do extensive type checking except for a few cases.
...
var unwrapSingle = (function unwrapping(){
